...
# purpose of gdagr: make google dorking easier 
# and faster and find information about the webpages the info is found on. 
# potential danger of gdagr: could get you blacklisted. (Maybe???)

# future features:
# enter a keyword for more focused search
# users get to try more commands

# future link for more detailed queries: https://practicaldatascience.co.uk/data-science/how-to-scrape-google-search-results-using-python

# it stands for
# google dorking automation and general reconaisance
